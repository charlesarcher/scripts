...
for OPTION in $CONFIG; do
    case ${COUNT} in
        ...
        5)
		    ...
		    case ${FIRSTDEVICE} in
			amstub)
			    export DEVICES="$DEVICES:amstub,am_ofi,stub,ofi,shm"
			    ;;
			stub)
			    export DEVICES="$DEVICES:stub,am_ofi,ofi,amstub,shm"
			    ;;
			ofi)
			    export DEVICES="$DEVICES:ofi,am_ofi,stub,amstub,shm"
			    ;;
			shm)
			    export DEVICES="$DEVICES:shm,am_ofi,ofi,stub,amstub"
			    ;;
			am_ofi)
			    export DEVICES="$DEVICES:am_ofi,shm,ofi,stub,amstub"
			    ;;
			*)
