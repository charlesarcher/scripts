...
export CFLAGS="-ggdb -O3 -DNDEBUG -fomit-frame-pointer -finline-functions -fno-strict-aliasing ${EXTRA_OPT}"
export CXXFLAGS="-ggdb -O3 -DNDEBUG -fomit-frame-pointer -finline-functions -fno-strict-aliasing ${EXTRA_OPT}"
#export CFLAGS="-O0 -Wall -Wextra"
#export CXXFLAGS="-O0 -Wall -Wextra"
